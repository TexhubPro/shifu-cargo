...
class Profile extends Component
{
    ...
    public function mount($id = null)
    {
        ...
        // $photos = Telegraph::bot('8407155944:AAG8fIkZS5AXDWgDu69boaAK_g1aoWt4o5c')->userProfilePhotos('1039537210');
        ...
        if ($fileId) {
            ...
            $this->avatar = $avatarUrl; // прямая ссылка на аватар
        } else {
            $this->avatar = null; // прямая ссылка на аватар
        }
        // dd($avatarUrl);
    }
